...
# ╔═╡ a6400922-1ce0-4140-b367-8cdad4bddc20
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ fde39cf0-8108-11f1-a128-17d0fec2f46c
md"# Continuous Compound Interest"

# ╔═╡ b4a770a5-c60b-42a0-a8fd-023a8e3adf11
md"## Add packages"

# ╔═╡ 5774ebe4-88c6-45e7-af2e-696b548a8406
md"### Multiple Sliders"

# ╔═╡ 96046e8d-9248-4867-b3dc-7699a3067bbe
begin
	driver = (@bind driverF Slider(50.0:90.0, default = 72.0, show_value=true))
	passenger = (@bind passengerF Slider(50.0:90.0, default=72.0, show_value=true))
...
# ╔═╡ a6e4f1b9-9ab3-4e3b-89e2-c2d7a3853794
driverC = round(5 / 9 * (driverF -32), digits = 1)

# ╔═╡ aee51d9d-eaa2-4ab0-8e43-4264d5324ddc
passengerC = round(5 / 9 * (passengerF -32), digits = 1)

# ╔═╡ bb5777a2-3651-41da-93b6-968ee999cc40
md"""
Driver Temperature: $(driverF) Farenheit | $(driverC) Celcius \
Passenger Temperature: $(passengerF) Farenheit | $(passengerC) Celcius 
"""

# ╔═╡ e7ef1d82-763a-4f03-b3b3-af52497a8beb
md"""
## Describe Problem
"""

# ╔═╡ 3a2868eb-f6a1-4df6-af57-6fd99e9f4330
md"""
### Continuous Compound Interest Problem 
"""

# ╔═╡ d1bd9c38-a4e2-42e8-a4ff-7d035af4d92d
md"""
$\frac{du}{dt} = f(u,p,t) = pu$
"""

# ╔═╡ 3d9c55f4-58bd-4658-99fc-4cc76eb3d25a
md"""
## Define Function
"""

# ╔═╡ 619846c5-ac68-4f84-a6c9-11a926828106
f(u,p,t) = p * u

# ╔═╡ 709e38c9-48ca-47ba-a0fa-8941b9b2c3de
md"""
## Asssign Variables
"""

# ╔═╡ 7dadc34a-c9ff-4d27-8707-4938d12a4b79
md" Beginning Balance: $(@bind u_begin Slider(1.0:1000.0, default = 1.0, show_value = true))"

# ╔═╡ 312d6cfe-c48e-4005-abe7-d2745cc665cb
md" Interest Rate: $(@bind p Slider(0.01:0.01:1.0, default = 1.0, show_value = true))"

# ╔═╡ bd25a92a-a15c-48fc-b072-9150b1187c03
t_begin = 0.0

# ╔═╡ 52a9b4b9-e83c-425f-8657-1c9a9651048a
md" Years: $(@bind t_end Slider(1.0:50.0, default = 1.0, show_value = true))"

# ╔═╡ 5e48f76f-99a9-42de-9206-5441bcbd98be
tspan = (t_begin, t_end)

# ╔═╡ 7ffa4b5a-a6ec-4e77-8e22-22186e81c041
md"""
## Define ODE Problem
"""

# ╔═╡ 36d86873-1c72-4322-b182-a18e696f64f8
prob = ODEProblem(f, u_begin, tspan, p)

# ╔═╡ 3d7e9c6a-15a5-4fb4-a5b4-470613731a2c
md"""
## Solve Problem
"""

# ╔═╡ ce615c74-31e8-4308-bca4-1cbdb0e0f9fc
sol = solve(prob)

# ╔═╡ ee37afc2-d930-4e7f-b265-a280e7b3bcc5
md"""
## Plot Solution
"""

# ╔═╡ 8691205f-78b0-43d7-8a6d-4800d5e4fa3a
plot(sol,
	legend = false
)

# ╔═╡ 02615a1e-2c47-4f23-a68f-4f67ae3c6181
sol(1)

# ╔═╡ c0e54c23-8005-4c79-a020-e6be9f7b9d89
EULER = ℯ
