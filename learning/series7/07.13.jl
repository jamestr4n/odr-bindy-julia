...
# ╔═╡ 38da0b54-fde0-4b61-9b66-fb30d483462a
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 78f951e0-9500-11f1-a07a-cdfbc8edd486
md"""
# 1D Heat Equation
"""

# ╔═╡ 37d66e7a-5209-4973-996c-0dfd8a142bc1
md"""
## Describe Problem
"""

# ╔═╡ ab5706a1-7e65-46b1-bc10-23bcfb8884fd
md"### Partial Differential Equation (PDE)"

# ╔═╡ a09e8ef3-8b8c-4a1d-8600-0a8f85d97c94
md"#### Heat Equation"

# ╔═╡ da305e84-9f69-4d13-bf0e-c3080d697a85
md"$\frac{\partial u}{\partial t} = \alpha \frac{\partial^2 u}{\partial x^2}$"

# ╔═╡ 18993286-ebc1-40ba-a4a4-8c3dde57978b
md"where $u$ is Temperature, $x$ is position, $t$ is time,"

# ╔═╡ b62b07db-cd12-4996-a9a6-6c1d9f1210fc
md"and $\alpha$ is a positive coefficient called the thermal diffusivity of the medium."

# ╔═╡ b3641087-dca7-4386-b040-dc4ac1c5e9f9
md"$\frac{\partial^2 u}{\partial x^2} = \frac{u_{i-1} - 2 u_i + u_{i+1}}{dx^2}$"

# ╔═╡ 753755f7-ee65-4c24-affe-aad030cb4b72
md"#### DifferentialEquations.jl"

# ╔═╡ 00e2b8c6-38e0-4733-98c7-df79a55bd8c3
md"$f(du, u, p, t) =
\begin{cases}
...
# ╔═╡ 648ac69d-ea8a-488d-b1ca-fe1c2f555c24
md"## Assign Variables"

# ╔═╡ 05f07646-38ae-4d5b-b015-df2777cf5417
md"### u: Temperature T is a function of position x and time t"

# ╔═╡ d85d5159-e2e9-4561-9008-ce4964578435
md"#### Position Along 1-D Wire"

# ╔═╡ a3d78af7-2a99-4f7c-b1fa-b452ae3a59ba
L = 1.0

# ╔═╡ 78004a46-1bb5-40dc-8a16-636ce55557b3
dx = 0.01

# ╔═╡ efeff4cf-6e42-41e9-9a0a-9024576d5ec0
x = 0.0:dx:L

# ╔═╡ 01d4712c-1316-4764-9b26-567c2a6ee772
md"#### Initial Temperatures Along 1-D Wire"

# ╔═╡ 5bb7de84-88b6-47b4-ac72-17c6b11f286b
@bind reset Button("Reset")

# ╔═╡ 4b2a9ec8-5d0f-48a6-87a0-39befad1887d
begin
	reset
	md"""
	Temperature ||
...
# ╔═╡ 9a78ca18-b66a-4bbd-b3f0-5ac32e88b454
u_begin = [i < L / 2 ? left_temp : right_temp for i in x]

# ╔═╡ 1751a5b3-a1f1-41a9-8e08-42d494019ba5


# ╔═╡ 797e6272-971b-4524-bdb5-58afbe976581
md"### p: Parameters alpha and dx"


# ╔═╡ 43e1da77-1b37-4d44-9598-646f16d8b47e
begin
	reset
	md"alpha: $(@bind alpha Slider(0.0:0.001:2.0, default = 0.5, show_value = true))"
end

# ╔═╡ ef016326-89c9-49de-87c0-ce5d42ebadb6
p = [alpha, dx]

# ╔═╡ 04b1add1-2a34-4abd-97bb-164b318484a9
md"Note: dx already defined above."

# ╔═╡ ea5d7625-4e11-43de-888c-13a49d815cd3
md"### t: Time"

# ╔═╡ 68e8b44d-1054-4cbd-8510-d7bd5445edc1
t_begin = 0.0

# ╔═╡ 30bded23-b71a-4cf5-9c70-a9aaef3e5d19
begin
	reset
	md"Time: $(@bind t_end Slider(0.0:0.001:1.0, default = 0.0, show_value = true))"
end

# ╔═╡ 9093e657-2941-4bf4-a41e-9bd300f4b0b9
tspan = (t_begin, t_end)

# ╔═╡ 2f0f85d4-8e95-454c-82cf-688ebe4085c4
md"## Define System of First Order ODEs Problem"

# ╔═╡ d7a923d2-05a7-42fe-98a8-59537789ad7f
prob = ODEProblem(heat_equation, u_begin, tspan, p)

# ╔═╡ 2d32ddd5-9d57-492b-a6da-6d22a74f41f1
md"## Solve Problem"

# ╔═╡ aa0b23c9-e26e-4d17-9cd0-24638dd07768
sol = solve(prob)


# ╔═╡ 24a49110-c1b9-4490-bcad-3d5049bd412e
T = sol[end]

# ╔═╡ ec606cc3-d985-4072-8217-cb923406e3e7
Tleft = T[1]

# ╔═╡ 00964642-65d4-4e71-af09-736c16770da0
T25 = T[2]

# ╔═╡ bdf57aab-0b40-468d-8e97-1f65a17fb005
T50 = T[1]


# ╔═╡ eae613f9-6ff4-4217-84f3-bc37b53fabb0
Tright  =T[end]

# ╔═╡ 6d8399de-17d0-4158-9fab-31f37f2ab03d
md"""
## Plot Solution
"""

# ╔═╡ 1c0822d8-c8cf-49ee-aa4f-a81ee6dcd4b6
plot((x, T),
	legend = false,
	linewidth = 3,
...
# ╔═╡ 2565d287-8b22-436a-bbdb-236f1a9d71c6


# ╔═╡ 59b5ec20-e7c2-4cf0-9c41-dceb2b2bc8c6
...
manifest_format = "2.0"
project_hash = "5e8c8c6960adf3890fa007fc7474c8394d11b58c"
