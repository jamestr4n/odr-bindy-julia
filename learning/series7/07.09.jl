...
# ╔═╡ a12c7d29-63c3-470a-9d6d-c0feff3c392a
using DifferentialEquations, Plots, PlutoUI;plotly

# ╔═╡ 53d51fd0-8c4e-11f1-9891-7308c5b28ff3
md"""
# Lorenz System
"""

# ╔═╡ bb2d442d-22e7-4b91-a468-81ceda71a127
md"""
## Describe Problem
"""

# ╔═╡ e6f3d9ff-d7b6-408a-9590-e43fc8978a1e
md"""
$\begin{align}
...
# ╔═╡ f3c6fcd2-542c-4607-9ddd-37cdabd51c9b
md"""
## Define Julia Function
"""

# ╔═╡ d3951f48-030a-4c5a-b14f-87c411e4930a
...
# ╔═╡ 39060ce2-8556-4e43-a90d-0a4fabb274cc
@bind reset Button("Reset")

# ╔═╡ ac7283e4-0135-40f1-8664-1df1e0f1b1b7
begin
	reset
	md"""
	Initial ||
	x: $(@bind x_begin NumberField(0:1, default = 0)) ||
	y: $(@bind y_begin NumberField(0:1, default = 1)) ||
	z: $(@bind z_begin NumberField(0:1, default = 0))
	"""
end

# ╔═╡ e5be294e-66c2-4b60-8d80-6691f38f3198
u_begin = [x_begin, y_begin, z_begin]

# ╔═╡ 1e2b9d7a-f415-41cc-befb-ac8b1c8f2fe3
begin
	reset
	md"""
	Parameters ||
	sigma: $(@bind sigma Scrubbable(0.0:0.1:20.0, default = 10.0)) |
	rho: $(@bind rho Scrubbable(0.0:0.1:50.0, default = 28.0)) |
	beta: $(@bind beta Scrubbable(0.00:0.01:5.00, default = 8/3, format = ".2f"))
	"""
end

# ╔═╡ 1ac9c5b9-d119-4f06-b55a-1608e1d6c462
p  = [sigma, rho, beta]

# ╔═╡ 078beeaf-2cca-4e81-abe2-334a60d08729
t_begin = 0.0

# ╔═╡ cfb2ada3-77d9-4a1b-8715-9e966dcbde55
t_end = 100.0

# ╔═╡ 47bc75cc-d5e4-47f4-a879-f284aee4327a
tspan = (t_begin, t_end)

# ╔═╡ 0f83a999-9dc1-4fe0-808b-03d559f0966e
md"""
## Define and Solve System of First Order ODE Problem 
"""

# ╔═╡ d8b61e75-05b0-4f42-a013-f171ae326fd5
