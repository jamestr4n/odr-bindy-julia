...
# ╔═╡ 4eea5009-3215-43a9-8bba-dd11351283ed
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 807a7808-1167-4d00-b4d1-21d7084fab9d
using StochasticDiffEq

# ╔═╡ 2e2495fe-9273-11f1-a430-bb6cad1bef53
md"""
# Stochastic Differential Equation
"""

# ╔═╡ 06cd3fe1-0612-42ee-9c66-93e1c315fda4
md"## Describe Problem"

# ╔═╡ 1f20a72a-e331-446a-ab8f-8758215d77ba
md"$du = f(u, p, t)dt + g(u, p, t)dW$"

# ╔═╡ 55325140-a55d-4d3c-b5bf-1eff2760471f
md"where $f(u, p, t) = \alpha u$ and $g(u, p, t) = \beta u$."

# ╔═╡ e1c61d3e-66af-4469-bd5e-1746f9da5718
md"""
## Define Julia Functions
"""

# ╔═╡ 345cc4de-4224-4b58-b213-35a95c8c4174
md"""
### ODE
"""

# ╔═╡ 0c2d3e7e-c13b-474f-80c1-831824ce8e5a
md"""
### Noise
"""

# ╔═╡ bd615836-218e-4e0a-a827-6eb39daa1999
md"## Assign Variables"

# ╔═╡ 261c83ff-144b-42f5-9a10-6760ff36c510
md"### u: Quantity"

# ╔═╡ 55f43be7-4e9a-4a19-a95e-40ca112a947e
u_begin = 1.0

# ╔═╡ e3aa4b64-be52-4354-a2a7-e0ebc59b344a
md"### p: Parameters alpha and beta"

# ╔═╡ 6c025f3e-4dae-49a9-82a8-4c4e8545391c
md"Growth Rate (alpha): $(@bind alpha Slider(0.0:0.01:1.0, default = 1.0, show_value = true))"

# ╔═╡ 896d7f66-e18c-4023-85e5-02e8c8e4cfab
f(u, p, t) = alpha * u

# ╔═╡ 0b8a0e62-7d4d-4cb3-8ac6-2cd99c282b15
md"Volatility (beta): $(@bind beta Slider(0.0:0.01:1.0, default = 0.0, show_value = true))"

# ╔═╡ 078bb0ad-73e2-40c6-a493-bfc52f0974f6
g(u, p, t) = beta * u

# ╔═╡ ab1516cb-634a-4343-ab84-7a0e3757eb9b
md"### t: Time"

# ╔═╡ 82d8b8f6-47f8-413d-8bd2-04fce1785037
t_begin = 0.0

# ╔═╡ c1221304-6e80-45d6-8f8b-a7b521d2ffe5
t_end = 1.0

# ╔═╡ bd75c019-d7e4-47dd-b211-4ee9d83745f9
tspan = (t_begin, t_end)


# ╔═╡ f21d3cdd-4c18-4da8-999f-38b90ec71fdc
md"Note: Time Step required for EM() solver."

# ╔═╡ ca0f06ef-bc0b-4909-b626-58b324dcb62d
t_step = 0.0001

# ╔═╡ bc041fd4-7010-45ca-9dc8-49a94b81e0aa
md"## Define Problems"

# ╔═╡ 9ca7d75f-36ea-4c5d-abae-e9d843be2b1f
md"### Define ODE Problem"

# ╔═╡ 2b1d8afb-3343-4b4f-8008-86a26e643122
prob_ODE = ODEProblem(f, u_begin, tspan)

# ╔═╡ 71911a36-c56c-445f-a1ef-180f98e26fad
md"""
## Define SDE Problem
"""

# ╔═╡ afc8f890-f9c3-45b9-8be3-480c947d876e
prob_SDE = SDEProblem(f, g, u_begin, tspan)

# ╔═╡ d6a99cf3-02b2-4659-9125-c39126b7f21c
md"""
## Solve Problems
"""

# ╔═╡ abdd0855-367e-4ae5-9f2a-bc3065367cc8
sol_ODE = solve(prob_ODE)

# ╔═╡ 5ab29a51-8837-4b95-bfde-2c26b06a59c8
@bind new_sol Button("New Solution")

# ╔═╡ 8e6e480e-c6c0-4d30-9d50-76276aba2244
begin
	new_sol
	sol_SDE = solve(prob_SDE, EM(), dt = t_step)
end

# ╔═╡ bd3be320-063f-4993-8017-e28ca1141ab2
md"""
## Plot Solutions
"""

# ╔═╡ 51a82919-b16c-4353-81a4-db6dcca37735
@bind new_plot  Button("New Plot")

# ╔═╡ 5a1c6089-80f3-4eaa-8267-a4f6afe5c236
begin
	new_plot
	p_ODE = plot(sol_ODE,
		legend = false,
		linewidth = 3,
		title = "Stochastic Differential Equation (ODE + Noise)",
		xaxis = "Time",
		yaxis = "Quantity",
		formatter = :plain,
		widen = true,
...
# ╔═╡ 0dbb5a78-0696-40a5-a5a5-9a1fb2682ff8
plot!(p_ODE, sol_SDE, alpha = 0.75)
...
manifest_format = "2.0"
project_hash = "7960e9c274f53e5133d6ffc8450476b8232d25b1"
...
git-tree-sha1 = "87e2e1fccacc3b3d36658b7ebc33326cd65998d0"
...
git-tree-sha1 = "c6acc3ee837cae1abc382569d9fb3254a7974e11"
...
git-tree-sha1 = "62c51fdbaf278b367b55da18294ee47fa59ff493"
...
git-tree-sha1 = "6ff9da6c316bf7011fd4419edd6b1841d57bc771"
...
git-tree-sha1 = "2c67acfea450f0c9cb92a806ccd85532158a77b3"
uuid = "43230ef6-c299-4910-a778-202eb28ce4ce"
version = "2.4.1"

[[deps.OrdinaryDiffEqRosenbrockTableaus]]
git-tree-sha1 = "5cafda38170bb6124e3a3d00837661cf15b0f2c3"
...
git-tree-sha1 = "2388522174dc7711f043f8856d08525263ce1c35"
...
git-tree-sha1 = "b04f109740bc126e48727e705e1066b11e0bfd89"
...
git-tree-sha1 = "07a1a363e127cfa76019da18492859494cf7281d"
...
git-tree-sha1 = "93f3d46d26feeb32b282191bba73332f859b6fd7"
...
git-tree-sha1 = "b5ca6abcab3d0ce55d5a8c2f9d182480ea599455"
...
git-tree-sha1 = "f97265fb6e184beec0332ca841c955aa5e55abb8"
uuid = "aefaaa88-39f2-4e89-b162-d61b7e8cc81b"
version = "2.0.2"

[[deps.StochasticDiffEqLevyArea]]
deps = ["LinearAlgebra", "Random", "SpecialFunctions"]
git-tree-sha1 = "2ce5bb083cba503b377b2a5aaf9c523074aba911"
uuid = "90dbc90e-856a-4131-af2c-e8c5aa0f35b5"
version = "2.0.2"

[[deps.StochasticDiffEqLowOrder]]
deps = ["DiffEqBase", "DiffEqNoiseProcess", "LinearAlgebra", "MuladdMacro", "OrdinaryDiffEqCore", "RecursiveArrayTools", "Reexport", "SciMLBase", "StaticArrays", "StochasticDiffEqCore"]
git-tree-sha1 = "384fb1d3df33e2f5cb62e7f84e7c782291399da9"
...
git-tree-sha1 = "2d286355ed4bf078fd5d9f64cc304a37639ee6fd"
...
git-tree-sha1 = "9177079368bce75694021655a444f57f95381d9a"
uuid = "db241ea8-0e6b-4abc-8f2d-1adff2294fd9"
version = "2.0.2"

[[deps.StochasticDiffEqRODE]]
deps = ["DiffEqBase", "LinearAlgebra", "MuladdMacro", "OrdinaryDiffEqCore", "RecursiveArrayTools", "Reexport", "SciMLBase", "StaticArrays", "StochasticDiffEqCore"]
git-tree-sha1 = "5153b0594502b372b52daf0c12512a00c9f7ca59"
...
git-tree-sha1 = "10f8f9fbcee994bb72ba096adf272d349058d840"
