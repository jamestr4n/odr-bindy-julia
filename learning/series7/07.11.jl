...
# ╔═╡ d4623a17-5242-49da-b447-c83668b37b60
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 5efb9160-91b1-11f1-9968-614b982e7cf8
md"""
# Three Body Problem
"""

# ╔═╡ 27ee443c-37db-4a31-8069-cebf35d05d4e
md"""
## Describe Problem
"""

# ╔═╡ 681c5c0b-a2bd-47d3-bf27-38b337341541
md"$\begin{align}
...
# ╔═╡ 6908f5ef-dc20-4b06-b42c-6855e4631029
md"$f(du, u, p, t) =
...
# ╔═╡ 04f3300c-4306-423c-8fbc-2bc4f0c1d16e
md"""
## Define Julia Function
"""

# ╔═╡ 1d5a158b-09cf-4b3f-a093-c1d01809b857
...
# ╔═╡ 04569787-24d1-4a7a-9d53-158c1d1aa9e9
md"""
## Assign Variables
"""

# ╔═╡ 62be2691-4b99-49ac-8c60-9c5d13f81f41
md"### u: x1, y1, x2, y2, x3, y3, vx1, vy1, vx2, vy2, vx3, vy3"

# ╔═╡ 4a641720-2666-4e53-bd4b-c9bfdf710a4a
md"#### Initial Positions"

# ╔═╡ 9d1c2d06-82d6-469f-98b4-cd097c374d4c
@bind reset Button("Reset")

# ╔═╡ 7d0fdc1f-8bef-43cd-a59d-215d22bd2a04
begin
	reset
	md"""
	Positions ||
...
# ╔═╡ 816a7041-dd7a-4a86-a20c-e680747fcb03
begin
	reset
	md"""
	Velocities ||
...
# ╔═╡ acb7c0b0-2eaa-42a7-9a45-91dd65516a80
md"##### Initial Conditions"

# ╔═╡ 22bd7c33-aac2-4385-a1e1-32c57764f437
u_begin = [
	x1_0, y1_0, x2_0, y2_0, x3_0, y3_0,
	vx1_0, vy1_0, vx2_0, vy2_0, vx3_0, vy3_0
]

# ╔═╡ bef6fe4d-5650-4a9f-bb77-6720dc0d3efc
md"### p: Parameters m1, m2, m3"

# ╔═╡ 14e30cf1-27f3-4472-a135-74153894c959
begin
	reset
	md"""
	Masses ||
	m1: $(@bind m1 Scrubbable(0.01:0.01:2.0, default = 0.1, format = ".2f")) |
	m2: $(@bind m2 Scrubbable(0.01:0.01:2.0, default = 0.1, format = ".2f")) |
	m3: $(@bind m3 Scrubbable(0.01:0.01:2.0, default = 0.1, format = ".2f")) |
	"""
end

# ╔═╡ 222d76bd-93a4-40b7-bc75-baff6666c8ac
p = [m1, m2, m3]

# ╔═╡ 5bc65567-c89e-4cfa-a0a8-fb45fd618e3c
md"### t: Time"

# ╔═╡ 70b4e3df-991c-4ebf-8cf1-604c73ad749d
t_begin = 0.0

# ╔═╡ 9062d5a8-4fb2-4ca1-8b9c-7be79ac99a6e
begin
	reset
	@bind t_end Slider(0.0:0.001:100.0, default = 100.0, show_value = true)
end


# ╔═╡ c02b5185-80fe-42e9-b6d7-1db66627403e
tspan = (t_begin, t_end)

# ╔═╡ 87ed96c0-48d4-430a-b328-e7db7bb70517
md"## Define System of First Order ODEs Problem"

# ╔═╡ 7903dddf-13c9-4d2e-bff9-6519d23af1fd
prob = ODEProblem(three_body, u_begin, tspan, p)

# ╔═╡ b095f6d0-bdcf-4b32-ba3a-4d143689b897
md"## Solve Problem"

# ╔═╡ 0442fef5-cce1-469c-926c-1795bead050d
sol = solve(prob, Vern7(), reltol = 1e-16, abstol = 1e-16)

# ╔═╡ 21057afe-3420-4b7d-90c1-a2cc1ce72a09
md"## Prep for Plotting"

# ╔═╡ 8672e60e-138d-4a71-a1d5-740182f4b32a
md"### Obtain Position Values from Solution"

# ╔═╡ 89821e21-fc60-4106-90c1-8f582b0d8fe7
...
# ╔═╡ fba1fbcc-fde0-4979-b7b8-b8b9dcc1c3a2
x_values, y_values = values(sol)

# ╔═╡ 16e81e00-9231-445f-b8d8-7e49cd5ae8ba
x1_end = x_values[1][end]

# ╔═╡ 5e72265c-47cb-457d-8336-f2556ff8e37c
y1_end = y_values[1][end]

# ╔═╡ 7e227aa9-03a9-4a5c-9b00-af6fd91fe11e
x2_end = x_values[2][end]

# ╔═╡ 22469157-d2fa-42d4-ac75-d39d40d68edf
y2_end = y_values[2][end]

# ╔═╡ 0145f4d7-12ef-472e-8336-a4b534018ac6
x3_end = x_values[3][end]

# ╔═╡ 240bded4-d5e3-407b-b59b-6d1bc2ad742e
y3_end = y_values[3][end]

# ╔═╡ 19493f15-56a1-451e-899b-9079f1c979e2
md"## Plot Solution"

# ╔═╡ 18aea512-9c44-499b-9a46-f77efd6575b5
plot(sol)

# ╔═╡ cea95eaa-cba1-4a5c-8ba9-4d174d63e445
julia = Colors.JULIA_LOGO_COLORS

# ╔═╡ 1c15f96c-46a1-4b4c-b218-d76f64a0c28f
...
# ╔═╡ faf2e687-61a7-4ba8-abbc-f5e4a22f41e9
scatter!(traj,
...
# ╔═╡ 61ba3166-c065-4f95-9a50-6e168836f06b


# ╔═╡ b86dbeb9-41da-4de0-9728-a4db32db638a
