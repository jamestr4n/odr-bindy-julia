...
# ╔═╡ 17b1e1bc-5b69-4619-ab12-123f8f7d5746
using DifferentialEquations,Plots,PlutoUI;plotly()

# ╔═╡ c0f26640-8690-11f1-a1bb-31d94da754aa
md"""
# Simple Harmonic Motion
"""

# ╔═╡ b085d7d6-6a89-4048-879b-59456afedd73
md"""
## Describe Problem
"""

# ╔═╡ 00f65de2-9a89-4500-8d27-370f4a9a6eb6
md"""
## Second Order ODE
"""

# ╔═╡ 4496249f-a358-4640-8729-1fbdb2840ffb
md"""
$F_s = -kx$
"""

# ╔═╡ 23ba6988-ba66-4a1c-a237-c395cc04a145
md"""
$F=ma$
"""

# ╔═╡ 96e18f6e-1ecc-4bff-a632-f8c0f3773501
md"""
$a=\frac{d^2x}{dt^2}$
"""

# ╔═╡ a1fbb4ce-c6f8-412f-9d2c-c1e764dae37a
md"""
$F=m \frac{d^2x}{dt^2}=-kx$
"""

# ╔═╡ 7b0f98df-e168-4217-af8b-61cd2b608aff
md"""
$\frac{d^2u}{dt^2}=f(du,u,p,t)$
"""

# ╔═╡ 3d153a4e-c3ab-4296-9f01-7db649cbf285
md"""
$f(du,u,p,t)=-\frac{p[1]}{p[2]} u$
"""

# ╔═╡ be260425-5a9c-44bb-931a-d5b557cec52d
md"""
## Define Julia Function
"""

# ╔═╡ f492079e-cf77-4bb7-a278-c0147b09c796
...
# ╔═╡ 59723b88-87f3-4b72-986b-f772b6c02238
md"""
## Assign variables
"""

# ╔═╡ 3c587656-1678-431c-9103-7054cf46599d
dx_begin = 0.0

# ╔═╡ aba5e9d3-4715-4e16-982c-938ffce2bdd1
md"""
Initial Position (m): $(@bind x_begin Slider(-0.25:0.01:0.25, default=0.25, show_value=true))
"""

# ╔═╡ 90931a7d-c761-468f-9236-2f86106fd2a8
md"""
Spring Constant (N/m): $(@bind k Slider(0.5:0.01:2.0, default=1.0, show_value=true))
"""

# ╔═╡ 617ae39e-4799-42f2-b04b-6d4a44f04cfb
md"""
Mass (kg): $(@bind m Slider(0.5:0.01:2.0, default=1.0, show_value=true))
"""

# ╔═╡ ca25e4f9-3033-4332-92e9-fdea88b8be3b
p = [k, m]

# ╔═╡ 5e71f113-05f0-47e2-b305-90519ee6da31
t_begin = 0.0

# ╔═╡ 6856672a-329f-4c97-b0a8-bc5cf5f7e6d6
md"""
Time (s): $(@bind t_end Slider(0:0.01:20.0, default=20.0, show_value=true))
"""

# ╔═╡ bfa17eae-c158-451b-a8cd-f6c250ddee14
t_span = (t_begin, t_end)

# ╔═╡ ceeb9a23-0715-429e-9624-7466e1455c08
md"""
## Define Second Order ODE Problem
"""

# ╔═╡ 64c215ac-10d5-431f-9832-17ffdb252230
prob = SecondOrderODEProblem(harmonic, dx_begin, x_begin, t_span, p)

# ╔═╡ 69eb596f-c14a-4e5e-b2d3-5a9cfdd88855
md"""
## Solve Problem
"""

# ╔═╡ 6d9349ce-98a9-4b4d-ab2e-83f3f3c585bb
sol = solve(prob)

# ╔═╡ 47e178f3-ebd3-41af-a20b-d3fa9aa6e8d4
md"""
## Plot Solution
"""

# ╔═╡ 15b7f8c6-cd7f-4fb1-8719-1f6c98fef81c
plot(sol)

# ╔═╡ bf4b3125-e521-4134-97dd-89ddfc2bed8c
