...
# ╔═╡ 2edca68c-053e-4432-a75b-3c50a0f9e0fe
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 1041d7d0-9050-11f1-8b71-4f4b79dd6889
md"""
# Double Pendulum
"""

# ╔═╡ 03369cca-5ea8-47dc-bd60-9c773dc72d29
md"""
## Double Pendulumm Problem
"""

# ╔═╡ b9fe225b-a5be-4198-9afe-d75818df2333
md"$f(du, u, p, t) =
\begin{cases}
du[1] = {\theta_1}' = \omega_1 \\
du[2] = {\theta_2}' = \omega_2 \\
...
# ╔═╡ 3bdb3afc-1377-41fb-97f5-b1345a7e8345
md"""
## Define Julia Function
"""

# ╔═╡ a451307f-0ef6-409b-b8d7-19f1652d3c00
...
# ╔═╡ 23fe43cb-acf7-4527-8880-8031f994a679
md"""
## Assign Variables
"""

# ╔═╡ 237004aa-1f82-4fad-bcfc-d5633cde8039
md"""
### u: theta1, theta2, omega1, omega2
"""

# ╔═╡ 01e13079-b188-4ef7-a5c0-d8bf0dce5308
begin
	reset
	md"""
	Initial Conditions ||
	theta1 (deg): $(@bind theta1d Scrubbable(0.0:0.1:180.0, default = 90.0)) |
	theta2 (deg): $(@bind theta2d Scrubbable(0.0:0.1:180.0, default = 120.0))
	"""
end

# ╔═╡ 01fb1a3c-870a-40e0-9bb4-8d7c8bd6cef2
theta1 = deg2rad(theta1d)

# ╔═╡ 5fa6a5fb-196a-4f9b-b77c-d335e9732f51
theta2 = deg2rad(theta2d)

# ╔═╡ b94e35c6-aa2f-4fe6-aa92-29511b10b4b8
omega1 = 0.0

# ╔═╡ e0fd3111-18bd-4b9c-8a1f-ebc0a3724ee3
omega2 = 0.0

# ╔═╡ 1a26e699-d7e1-46de-a84e-218126dc9ba5
u_begin = [theta1, theta2, omega1, omega2]

# ╔═╡ d9e655e4-f2ac-4e82-a9dd-4e383ac7e722
md"### p: Parameters m1, m2, L1, L2 and g"

# ╔═╡ 96e9aff3-672c-4b22-ae36-3f233cbc1a57
begin
	reset
	md"""
	Parameters ||
...
# ╔═╡ ee5902ac-b90e-4c40-bfb1-58e21fed194e
p = [m1, m2, L1, L2, g]

# ╔═╡ c7e14f05-aaaf-4ad1-9ba3-8a7c92be8de6
md"### t: Time in Seconds"

# ╔═╡ 68852f2c-48c2-4fd2-81f5-3a0cad5294ca
t_begin = 0.0

# ╔═╡ 88a80591-6685-42ce-95fe-9e5f1d772eb1
begin
	reset
	md"Time (s): $(@bind t_end Slider(0.0:0.01:100.0, default = 100.0, show_value = true))"
end

# ╔═╡ dc93e989-075d-45cd-bd62-13f495bfacb9
tspan = (t_begin, t_end)

# ╔═╡ 1f1a49b0-b848-4147-bc5a-53b47d68e491
md"## Solve Problem"

# ╔═╡ c863904d-d0a8-4803-be64-7a101a1d9e7b
prob = ODEProblem(double_pendulum, u_begin, tspan, p)

# ╔═╡ ca0d8802-946e-41b5-b0c5-1cd97e1bb699
sol = solve(prob, Vern7(), reltol = 1e-10, abstol = 1e-10)

# ╔═╡ 7edf54f4-6889-4674-b5c1-e8314e2d83a5
md"""
## Prep For Plotting
"""

# ╔═╡ 4f2a273f-f3a3-4618-b260-abb6fb166573
...
# ╔═╡ c9b0c803-232f-43c4-895f-4c82cfae0034
pendulum1, pendulum2 = polar2cart(sol)

# ╔═╡ fe996673-6315-4d52-ba51-a19d65c60f5a
x1 = pendulum1[1][end]

# ╔═╡ 14fa04a8-5410-407b-8555-63dd3a78e572
y1 = pendulum1[2][end]

# ╔═╡ cd0fa94e-5a90-4822-afd6-4c704a65087f
x2 = pendulum2[1][end]

# ╔═╡ ea7dc616-2fb7-4f73-8ef5-2f93d1be0d88
y2 = pendulum2[2][end]

# ╔═╡ 45b73a18-d8a7-4d2d-8a9a-7861272ed71f
md"""
## Plot Solution
"""

# ╔═╡ 22f3384a-cc62-4bdc-bda0-57c6946d27b0
plot(sol)

# ╔═╡ d8c01e20-fbfe-4859-ad80-99d9eb8e187c
...
# ╔═╡ 3632f738-ec4f-4fac-a6a4-1d236388ea7c
...
# ╔═╡ 0b5abe4b-9dbe-4778-af89-50e3fa7a4967
begin
	plot!(phase_x2y2,
		([0, x1, x2], [0, y1, y2]),
		color = :black,
...
# ╔═╡ 54e28dd2-734e-4e97-957d-28ef88ac4b00
