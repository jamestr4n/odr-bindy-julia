...
# ╔═╡ c6b5fcd1-e554-4b6c-b47f-be16d10bded3
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ 3576ae20-875b-11f1-a83b-23d065946e7e
md"""
# Lotka-Volterra Equations
"""

# ╔═╡ 7e291ae6-59d3-4601-b32c-2955dbcfdb4a
md"""
## Describe Problem
"""

# ╔═╡ 6bfd1979-3907-439d-a16f-7df19e26d5e1
md"""
$\begin{align}
...
# ╔═╡ 2be220cd-c307-4c4d-ad69-3e654269af02
md"""
## Define Julia Function
"""

# ╔═╡ 29cfeb8d-72a9-446d-9f9c-e40a0f24e47a
...
# ╔═╡ b4f9700e-de2b-489d-9e42-3603cfe176ae
md"""
Initial Baboon Population:
	$(@bind x_begin Scrubbable(1:20, default = 10))
"""

# ╔═╡ a009b798-ce18-47da-aef4-21fae21510be
md"""
Initial Cheetah Population:
	$(@bind y_begin Scrubbable(1:20, default = 10))
"""

# ╔═╡ 81f1a203-871b-4ecc-8f30-1f2752aabd5f
u_begin = [x_begin, y_begin]

# ╔═╡ e3e6b592-641d-4b58-9c1d-8cd6d38ec177
md"""
Baboon Growth:
	$(@bind alpha Scrubbable(0.1:0.1:2.0, default = 1.1, format= ".2f"))
"""

# ╔═╡ 321fe929-28b7-4ad0-b3fb-5ad791558013
md"""
Baboon Decline:
	$(@bind beta Scrubbable(0.1:0.1:2.0, default = 0.4, format= ".2f"))
"""

# ╔═╡ 270eca0b-816b-4f02-8fa2-d76627448863
md"""
Cheetah Decline:
	$(@bind gamma Scrubbable(0.1:0.1:2.0, default = 0.4, format= ".2f"))
"""

# ╔═╡ e38af5ff-0631-4ea1-a783-702cbb39f25b
md"""
Cheetah Growth:
	$(@bind delta Scrubbable(0.1:0.1:2.0, default = 1.1, format= ".2f"))
"""

# ╔═╡ aae7c7c7-4250-4ca2-8f48-fed73ef32f54
p = [alpha, beta, gamma, delta]

# ╔═╡ 40ad0089-eb71-4ee6-861c-b951679347ad
t_begin = 0

# ╔═╡ 64e2f540-c404-4a99-b691-e344bae8958a
md"""
Years: $(@bind t_end Slider(0:100, default = 100, show_value = true))
"""

# ╔═╡ a6a3462d-5160-431f-9994-781b5f8b212a
t_span = (t_begin, t_end)

# ╔═╡ 4dd420d9-dcac-4266-b895-fa71e4dc184f
md"""
## Define and Solve System of ODEs Problem
"""

# ╔═╡ 83dbdc2b-d1d5-4a23-89ce-0bdf5d8ad0d5
prob = ODEProblem(lotka_volterra, u_begin, t_span, p)

# ╔═╡ 927266ad-1abe-4c75-82ea-b1c77b3b5591
sol = solve(prob)

# ╔═╡ 0f51ebc4-36f3-4b73-8561-8b3cc4708e41
plot(sol)

# ╔═╡ 3730e2b2-a6f7-4622-8f58-03295bb4c48a
phase = plot(sol, idxs = (1, 2),
	legend = false,
	linewidth = 2,
	title = "Phase Space",
	xaxis = "Baboon Population",
	yaxis = "Cheetah Population",
	formatter = :plain,
	widen = true,
	xlims = (0.0, 30.0),
	ylims = (0.0, 15.0),
...
# ╔═╡ 418c22b2-360f-4fcd-8ef8-ed9639d91e89


# ╔═╡ 54cda184-68ec-4771-baba-1642512ad938
