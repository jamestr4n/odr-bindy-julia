...
# ╔═╡ 4915788b-313d-4988-8090-88d5de898883
using DifferentialEquations, Plots, PlutoUI; plotly()

# ╔═╡ cd1c7af0-8118-11f1-bbcf-ef2c9b33fb81
md"""
# Radiocarbon Dating
"""

# ╔═╡ 7de7620d-4591-4fac-bd6a-388e28ab8cc3
md"""
## Add Packages
"""

# ╔═╡ 99e3c6d0-c71c-4af8-9cff-0e8cdbeebcdf
md"""
## Describe Problem
"""

# ╔═╡ d834dec7-cc43-40cf-85b8-16e86c6b8c39
md"""
### Radiocarbon Dating Problem
"""

# ╔═╡ 01a08274-e363-4324-b3a6-2b7bd88bfc15
md"""
$\frac{du}{dt} =pu$
"""

# ╔═╡ 5f007693-c038-4cd8-8e70-4aa5944516e3
md"""
## Define Function
"""

# ╔═╡ 0ab0ba04-2d23-4ba5-8a20-310d23efbebc
f(u, p, t)=p * u

# ╔═╡ 26460c8d-6d86-4bae-951d-236e0c00eeea
md"""
## Assign Variables
"""

# ╔═╡ f6a9a8e3-48fd-4fc8-950b-610c8207679a
u_begin = 1.0

# ╔═╡ 83a424f9-1e4d-4e64-be82-a2da11c481df
p = -(log(2)/5730)

# ╔═╡ 586d2537-f76d-4a27-ad21-e153f9910eab
t_begin = 0.0

# ╔═╡ 70c4a24c-3b18-47b1-8f79-4ab2c7abc184
md"""
Years: $(@bind t_end Slider(1.0:50_000.0, show_value = true))
"""

# ╔═╡ 350b4f7e-67cc-426e-9f5e-35860fb9ea93
t_span = (t_begin, t_end)

# ╔═╡ aaa864ed-3ccb-4024-88e6-a1ccb2720dae
md"""
## Define ODE Problem
"""

# ╔═╡ 9fddc7bb-d04c-4d67-9e9d-ea2cc9119003
prob = ODEProblem(f, u_begin, t_span, p)

# ╔═╡ 0023cc6b-3b49-4e5e-b0e7-f3ef45426c2a
sol = solve(prob)

# ╔═╡ 8c651749-d4f4-400a-8506-61c6a6f7374e
sol(5730)

# ╔═╡ 381c57f5-7e54-46bb-9bbe-35de2c85ff0b
plot(sol,
	legend=false
)

# ╔═╡ 1775095d-d94f-4da6-a6f4-325feb5cc611
md"""
# Verhulst Equation
"""

# ╔═╡ 02ddc2af-0012-44dd-a1f6-3d8bc3e49202
md"""
## Describe Problem
"""

# ╔═╡ a9106593-bcde-428d-8b9a-461e10c4a0a9
md"""
$\frac{dN}{dt} = rN \left( 1-\frac{N}{K}\right)$
"""

# ╔═╡ 74f0c13a-15a7-438b-8cc3-5ce0c7e85ebd
md"""
#### Verhulst Equation Problem
"""

# ╔═╡ 1e5d4203-0975-46e8-a719-eb9d094eab55
md"""
$\frac{du}{dt}=f(u,p,t)$
"""

# ╔═╡ b9ab1e52-9d42-432d-b591-f200628f80c1
md"""
$f(u,p,t)=p[1]u \left(1-\frac{u}{p[2]}\right)$
"""

# ╔═╡ ddd6c463-dbab-49e1-ab30-89d9da6d6662
md"""
## Define Function
"""

# ╔═╡ 6ab35bcf-f139-4951-98b3-14a1d6a331dc
g(u,p,t) = p[1] * u * (1 - (u / p[2]))
