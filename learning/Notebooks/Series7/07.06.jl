...
# ╔═╡ eed5ee3a-d316-4a10-8e16-33a84547ee41
using DifferentialEquations, Plots, PlutoUI;plotly()

# ╔═╡ 68d80ae0-8128-11f1-bb75-0564a646f73a
md"""
# Projectile Motion
"""

# ╔═╡ 27d52a16-2ee0-4d5e-961b-33ae2f50ea4c
md"""
## Add Packages
"""

# ╔═╡ c87acb11-b1ed-4b2b-976c-0685a0bded6b
md"""
## Describe Problem
"""

# ╔═╡ 74c28375-c5d4-48c3-a6cb-0afbff27d272
md"""
$\frac{d^2u}{dt^2}=f(du, u, p,t)$
"""

# ╔═╡ 40ba7dd4-9002-4ce9-9e16-5ecea819abdd
md"""
### Projectile Motion Problem
"""

# ╔═╡ 558ae1eb-2778-4439-af1e-0d1e9e211a59
md"""
$f(du, u, p,t)=[\space 0,g\space]$
"""

# ╔═╡ 49a79a3a-f93d-4c97-868d-90e0d730371a
md"""
## Define Function
"""

# ╔═╡ fa1fdfd8-1147-4e11-aa9b-d2ef52f78e98
const g_earth = -9.8067

# ╔═╡ 7c1cd082-d5d1-4c1f-8b4f-0d376cdc91d7
const g_mars = -3.728

# ╔═╡ 7a8b5a34-ca08-4ca5-9a04-e2008183a446
const g_moon = -1.625

# ╔═╡ de7daf9b-a2c3-4ebd-b973-c405805cdc98
@bind select_g Select(["Earth", "Moon", "Mars"])

# ╔═╡ d5667e28-cdf2-4b65-ba43-3b625ff34974
if select_g == "Moon"
	g = g_moon
...
# ╔═╡ 149c80ab-baae-41b9-882b-5b15f3a6d279
f(du, u, p, t) = [0, g]

# ╔═╡ 9919f269-7902-48fb-b618-661983dbb340
md"""
## Assign Variables
"""

# ╔═╡ c0bf59f4-6c49-4939-952d-238437d5163e
md"""
Initial Velocity (m/s): $(@bind v_begin Slider(50.0:150.0, default=100.0, show_value = true))
"""

# ╔═╡ 630631a0-ae0f-4e03-b6ce-e09ea822ef5e
md"""
Angle in Degrees (m/s): $(@bind theta Slider(0.0:90.0, default=45.0, show_value = true))
"""

# ╔═╡ 33b68607-69c8-4768-ba54-11ff12692ba9
vx_begin = cosd(theta) * v_begin

# ╔═╡ c39791fb-9f56-4279-836c-662354854eb3
vy_begin = sind(theta) * v_begin

# ╔═╡ b71cc5f4-2e5e-46b2-944e-fbdeaa2260c7
du_begin = [vx_begin, vy_begin]


# ╔═╡ f56cd900-394a-40fb-85d9-4b2930ee8546
x_begin = 0.0

# ╔═╡ 289f610d-f33c-49c6-b2cf-077e3993fd21
y_begin = 0.0

# ╔═╡ 99ce76dd-5fec-4170-8990-3d3068422f1a
u_begin = [x_begin, y_begin]

# ╔═╡ c637f7be-b057-4f3c-932b-2ab913e06b94
t_begin = 0.0

# ╔═╡ a5f60fad-671c-4276-bee6-67a4dc3fd5a9
md"""
Seconds: $(@bind t_end Slider(0.0:0.1:20.0, default=20.0, show_value = true))
"""

# ╔═╡ 7b8364ac-7173-4e03-8f2c-41d4d133e081
t_span = (t_begin, t_end)

# ╔═╡ 5dfb9228-a606-4e81-a228-96334c93e6b3
md"""
## Define 2nd ODE Problem
"""

# ╔═╡ 8a5eff69-d3c6-446b-846a-06d92cbcfca1
prob = SecondOrderODEProblem(f, du_begin, u_begin, t_span)

# ╔═╡ b5357cc5-30f7-40ef-a7fe-acfd0ad594dd
sol = solve(prob)

# ╔═╡ 46553537-a581-4135-ab05-b9f4e7a69066
plot(sol)
